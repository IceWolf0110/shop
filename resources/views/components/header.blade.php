<flux:header container="true" class="bg-zinc-50 dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-700">
...
<flux:sidebar stashable="true" sticky="true" class="lg:hidden bg-zinc-50 dark:bg-zinc-900 border rtl:border-r-0 rtl:border-l border-zinc-200 dark:border-zinc-700">
    ...
    <flux:navlist variant="outline">
        ...
        <flux:navlist.group expandable="true" heading="Favorites" class="max-lg:hidden">
